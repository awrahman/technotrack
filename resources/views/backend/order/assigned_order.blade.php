...
@section('active_menu','Assign order')
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                @foreach($orders as $key=>$data)
                    @if(!\App\Assign_technician_device::where('order_id',$data->id)->where('status',0)->exists())
                        @else
                <tr>
                  <td>{{$key+1}}</td>
                  <td>
                    ...
                    <td>
                        @php($assigen_technician = \App\Assign_technician_device::where('order_id',$data->id)->where('status',0)->get())
                    ...
                    <td>
                        ...
                        @if($assigen_technician = \App\Assign_technician_device::where('order_id',$data->id)->where('status',0)->exists())
